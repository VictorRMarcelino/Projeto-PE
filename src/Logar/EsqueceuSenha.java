...
public class EsqueceuSenha extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Confirmar.setBounds(107, 55, 93, 25);
        ...
        jLabel3.setBounds(-26, -26, 360, 200);
    ...
    private void ConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConfirmarActionPerformed
       if (cpf.getText().isEmpty()) {
        ...
        try {
            ...
            String Query = "SELECT * FROM funcionários WHERE Cpf = '"+cpf.getText()+"'";
            ResultSet Result = stmt.executeQuery(Query);
            while(Result.next()){
                senha.setText(Result.getString(2));
            }
